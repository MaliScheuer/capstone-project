            ...
            <a href='/search-mentors'>
                <svg xmlns="http://www.w3.org/2000/svg" width="22.374" height="22.374" viewBox="0 0 22.374 22.374">
                    <g id="Icon_feather-search" data-name="Icon feather-search" transform="translate(-4 -4)">
                        <path id="Pfad_23" data-name="Pfad 23" d="M23.315,13.908A9.408,9.408,0,1,1,13.908,4.5a9.408,9.408,0,0,1,9.408,9.408Z" transform="translate(0 0)" fill="none" stroke="#fff" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" />
